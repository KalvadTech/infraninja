...
def test_pf_setup_success():
    ...
    with (
        ...
        patch("infraninja.security.freebsd.pf_setup.files"),
        patch("infraninja.security.freebsd.pf_setup.server") as mock_server,
        patch("infraninja.security.freebsd.pf_setup.service") as mock_service,
    ):
...
def test_pf_setup_module_not_loaded():
    ...
    with (
        ...
        patch("infraninja.security.freebsd.pf_setup.server") as mock_server,
        patch("infraninja.security.freebsd.pf_setup.files"),
        patch("infraninja.security.freebsd.pf_setup.service"),
    ):
